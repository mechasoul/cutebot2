...
//    nativeLoader.load();
	  //TODO figure out where to put this dll to have it work with nativeLoader, rather than just calling System.load lol
	  System.load(Path.of("./udpqueue.dll").toAbsolutePath().toString());
